...
@endif
	...
	<form class="text-center border border-light p-5" action="{{ route('personnel_store') }}" method="post">

		{{ csrf_field() }}

		<p class="h4 mb-4">Add Personnel </p>
	    ...
	    <button class="btn btn-info my-4 btn-block" type="submit">Add Personnel</button>
